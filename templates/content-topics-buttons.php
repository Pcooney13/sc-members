        ...
        <div class="row">
        	<div class="col-sm-12">
                ...
                <div class="controls">
                    ...
                    <ul class="topics-menu nav nav-pills">
                    <?php foreach ($custom_terms as $custom_term){ ?>
                    <li><button class="btn btn-primary filter" data-filter=".<?php echo $custom_term->slug; ?>"><?php echo $custom_term->name; ?> <span class="badge"><?php echo $custom_term->count; ?></span></button></li>
                    <?php } ?>
                    </ul>
                </div>
