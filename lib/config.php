 ...
 */
define('GOOGLE_ANALYTICS_ID', 'UA-72968749-1'); // UA-XXXXX-Y (Note: Universal Analytics only, not Classic Analytics)
...
function roots_display_sidebar() {
  $sidebar_config = new Roots_Sidebar(
    ...
    array(
      //'is_404'
	  array( 'is_page', array('Login','member-registration', 'contact-us'))
    ),
    /**
